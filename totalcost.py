...
conf = {
    ...
    'mapred.bq.input.project.id': 'grand-magpie-222719',
    'mapred.bq.input.dataset.id': 'salesdata',
    'mapred.bq.input.table.id': 'data',
}
# Output Parameters.
output_dataset = 'salesdata'
output_table = 'output'
...
total_cost = (
    ...
    .map(lambda x: (x['Location'].lower(), float(x['Cost'])))
    .reduceByKey(lambda x, y: x + y))

# Display 10 results.
pprint.pprint(total_cost.take(10))
